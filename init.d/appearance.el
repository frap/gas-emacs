...
(defun use-presentation-theme ()
  (interactive)
  (when (boundp 'gas/presentation-font)
    (set-face-attribute 'default nil :font gas/presentation-font)))

(defun use-default-theme ()
  (interactive)
  (load-theme 'default-black)
  (when (boundp 'gas/default-font)
    (set-face-attribute 'default nil :font gas/default-font)))

(defun toggle-presentation-mode ()
  (interactive)
  (if (string= (frame-parameter nil 'font) gas/default-font)
